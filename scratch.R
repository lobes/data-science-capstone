...
twit_sample <- twit_sample[, .(start = stri_replace_last_regex(ngram, " [a-z|'|0-9]+", ""),
...
discount_five_gram <- function() {
    ...
    for (i in 5:1) {    # going backwards
        ...
        # have to reset some discounts to 1 due to quirk of sample data having equal numbers of 3, 4, and 5 frequency 5grams
